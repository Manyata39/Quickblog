  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      ...
      <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>
        This is your space to think out loud, to share what matters, and to write without filters. Whether its one word or a thousand, your story starts right here,
      </p>
      ...
      <div className='text-center'>
        {
        input && <button onClick={onClear} className='bg-primary text-white px-8 py-2 m-1.5 rounded hover:scale-105 transition-all cursor-pointer'>Clear Search</button>
        }
      </div>
